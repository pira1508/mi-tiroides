...
// Primer slide del carrusel = hero DISEÑADO masculino que hace message-match con el ad (por ?angle).
// Paleta masculina (azul marino + verde + frasco real), copy del avatar hombre 45-65.
const HERO_JOVEN: Record<"apaga" | "esposa" | "peso", { src: string; alt: string }> = {
  apaga: { src: "/img/hero-hombre-apaga.jpg", alt: "No es la edad, es tu tiroides" },
  esposa: { src: "/img/hero-hombre-esposa.jpg", alt: "¿Tu esposo ya no es el mismo? Puede ser su tiroides" },
  peso: { src: "/img/hero-hombre-peso.jpg", alt: "Comes igual y la barriga no baja: es tu metabolismo, la tiroides lenta" },
};

// Slides neutrales (sirven a cualquier edad); se dejó fuera hero-1 (gancho de "edad", del avatar mayor).
// Antes/después de las 2 problemáticas más duras del avatar hombre:
// la panza que no baja y el sueño a toda hora. Van de primeros.
//
// ⚠️ El de la panza es un antes/después de ABDOMEN, decisión explícita de
// Andrés (4-ago) después de advertirle el riesgo. Se mitiga así y hay que
// mantenerlo así si alguien regenera la imagen:
//   · camisa PUESTA en las dos mitades — nunca torso desnudo;
...
const SIN_CARA = [
  ...
  },
  {
    ...
    momento: "Día 30",
    caption: "Energía estable durante el día. Se acaba el bajón de las 3pm. Empiezas a notar más fuerza y enfoque.",
  },
  {
...
const INGREDIENTES: Ingrediente[] = [
  ...
  },
  {
    n: "Vitamina D3",
    d: "2000 UI",
    resumen: "El 70% de los colombianos tiene niveles bajos.",
...
const TESTI_CORTOS = [
  {
    foto: "/img/hombre-jorge.jpg",
    nombre: "Jorge",
    edad: 58,
    ciudad: "Medellín",
    texto:
      "Vivía mamado, llegaba del trabajo y me desplomaba. A las pocas semanas dejé de apagarme a media tarde.",
  },
  {
    foto: "/img/hombre-alberto.jpg",
    nombre: "Alberto",
    edad: 56,
    ciudad: "Barranquilla",
    texto:
      "El examen decía “normal” y yo sin fuerzas. Con esto volví a rendir sin sentirme aporreado todo el día.",
  },
  {
    foto: "/img/esposa-marta.jpg",
    nombre: "Marta",
    edad: 53,
    ciudad: "Pereira",
    texto:
      "Mi esposo ya no era el mismo, vivía cansado. Le insistí, lo tomó, y hoy volvió a ser el de antes.",
  },
  {
    foto: "/img/hombre-ramiro.jpg",
    nombre: "Ramiro",
    edad: 63,
    ciudad: "Bogotá",
    texto:
      "Manejo todo el día y ya no daba. No era la edad: era la tiroides. Volví a tener pilas para el turno.",
  },
  {
    foto: "/img/hombre-mateo.jpg",
    nombre: "Mateo",
    edad: 38,
    ciudad: "Cali",
    texto:
      "Con 38 ya vivía sin energía y con la barriga que no bajaba. En unas semanas volví a sentirme yo.",
  },
];
...
const TESTI_LARGOS = [
  {
    ...
    rol: "Maestro de obra · 58 · Medellín",
    texto:
      "Llegaba del trabajo y me desplomaba en el sillón, sin ganas de nada. Pensé que era la edad. Desde la 4ta semana con MI TIROIDES dejé de apagarme a media tarde y volví a jugar con mis nietos.",
    tag: "Energía recuperada",
  },
  {
    foto: "/img/hombre-gustavo.jpg",
    nombre: "Gustavo Peña",
    rol: "Contador · 61 · Bogotá",
    texto:
      "Yo era el típico que decía 'eso no sirve'. Mi esposa me lo compró. Al mes me di cuenta de que ya no me dormía en el escritorio a las 3 p. m. Ya voy por mi tercer frasco.",
    tag: "Escéptico convertido",
  },
  {
    foto: "/img/hombre-william.jpg",
    nombre: "William Ríos",
    rol: "Ingeniero · 51 · Cali",
    texto:
      "La concentración se me iba a media jornada y me costaba pensar. Mi médico me habló de la tiroides. Con MI TIROIDES llevo 3 meses y volví a rendir en las reuniones sin la niebla.",
    tag: "Concentración",
  },
  {
    foto: "/img/hombre-ramiro.jpg",
    nombre: "Ramiro Cárdenas",
    rol: "Conductor · 63 · Bogotá",
    texto:
      "Manejo con familias atrás y ya no tenía fuerzas ni para el turno. El examen salía normal. Esto me devolvió las pilas: manejo todo el día sin quedar muerto.",
    tag: "Volvió la fuerza",
  },
  {
    foto: "/img/hombre-efrain.jpg",
    nombre: "Efraín Gómez",
    rol: "Comerciante · 57 · Bucaramanga",
    texto:
      "La barriga no bajaba aunque comiera igual que siempre, y vivía cansado. Con MI TIROIDES el metabolismo se me movió, solté algo de peso y ando con más energía.",
    tag: "Peso y energía",
  },
  {
    foto: "/img/hombre-jairo.jpg",
    nombre: "Jairo Mosquera",
    rol: "Pensionado · 65 · Quibdó",
    texto:
      "Creí que a mi edad tocaba resignarse a estar mamado. Mi hija me lo trajo. Hoy tengo energía para salir, caminar y estar con los nietos sin quedar muerto al quinto minuto.",
    tag: "Volvió a ser él",
  },
  {
    foto: "/img/hombre-carlos.jpg",
    nombre: "Carlos Beltrán",
    rol: "Publicista · 40 · Bogotá",
    texto:
      "Con 40 y ya vivía cansado, sin ánimo después del trabajo. Pensé que era el ritmo de vida. Con MI TIROIDES volví a rendir y a llegar con energía a la casa.",
    tag: "Energía a los 40",
  },
  {
    foto: "/img/hombre-diego.jpg",
    nombre: "Diego Marín",
    rol: "Independiente · 43 · Medellín",
    texto:
      "Trabajo todo el día de pie y llegaba muerto, sin ganas de salir con los niños. En un mes largo recuperé las pilas — ahora sí les cumplo el fin de semana.",
    tag: "Volvieron las pilas",
  },
  {
    foto: "/img/esposa-rosa.jpg",
    nombre: "Rosa Meléndez",
    rol: "Ama de casa · 55 · Santa Marta",
    texto:
      "Mi esposo vivía sin ánimo y sin ganas, y yo pensé de todo. Le revisaron la tiroides y era eso. Le insistí con MI TIROIDES y volvió a ser el hombre alegre de antes.",
    tag: "La esposa que lo vio",
  },
];
...
export default function Page() {
  ...
  const [angulo, setAngulo] = useState<"apaga" | "esposa" | "peso">("apaga");
  useEffect(() => {
    const a = new URLSearchParams(window.location.search).get("angle");
    if (a === "apaga" || a === "esposa" || a === "peso") {
      setAngulo(a);
      setHeroIdx(0);
    }
  }, []);
  ...
  return (
    <>
      {/* Reskin masculino: sobrescribe la paleta verde por azul marino SOLO en /v5 */}
      <style>{`:root{--verde:#17384f;--verde-2:#2f6f62;}`}</style>
      {/* MARQUEE */}
        ...
        <div className="container hero">
          ...
          <div>
            <div className="badges" style={{ marginBottom: 12 }} role="group" aria-label="¿Qué te trajo aquí?">
              {(["apaga", "esposa", "peso"] as const).map((k) => (
                <button
                  key={k}
                  type="button"
                  onClick={() => { setAngulo(k); setHeroIdx(0); }}
                  className="badge"
                  style={{ cursor: "pointer", ...(angulo === k ? { background: "#17384f", color: "#fff", borderColor: "#17384f" } : {}) }}
                >
                  {k === "apaga" ? "No es la edad" : k === "esposa" ? "Mi esposo" : "La barriga no baja"}
                </button>
              ))}
            </div>
            ...
            <div className="rating-row">
              ...
              <span><strong>4.8/5</strong> basado en +2.500 clientes colombianos</span>
            </div>
            ...
            <div className="badges">
              ...
              <span className="badge" style={{ background: "#17384f", color: "#fff", borderColor: "#17384f" }}>
                🌿 Asistente incluido
              </span>
            </div>
            ...
            >
              ...
              tratar es otra semana mamado, sin fuerzas y con la barriga
              que no baja. Empezar hoy = primeros cambios en <strong>14 días</strong>.
            </div>
      ...
      <section className="section-tight section-beige">
        <div className="container">
          <div className="eyebrow">¿Qué dicen nuestros clientes?</div>
          <div className="review-strip">
            ...
            <div style={{ fontSize: 14, color: "var(--gris)" }}>
              <strong style={{ color: "var(--tinta)" }}>+2.500 clientes felices</strong>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="h2">Te tomas tu pastilla juicioso, comes bien, duermes…<br />y aun así vives mamado y sin fuerzas</h2>
          <div className="dolor-grid">
            {[
              ["🥱", "Cansancio que no se va", "Te despiertas agotado y a media tarde ya no das más, aunque dormiste bien."],
              ["⚖️", "La barriga no baja", "Comes igual que siempre pero el peso no se mueve o sigue subiendo."],
              ["🧠", "Niebla mental", "Te cuesta concentrarte, olvidas cosas y sientes la cabeza lenta."],
              ["🔋", "Sin fuerzas ni ánimo", "Ya no tienes pilas para el trabajo, la familia ni lo que antes disfrutabas."],
              ["🥶", "Frío y manos heladas", "Sientes frío cuando los demás están bien — señal de tiroides lenta."],
              ["😴", "Sueño que no repara", "Duermes y amaneces igual de aporreado, como si no hubieras descansado."],
            ].map(([emoji, t, d]) => (
          ...
          <p style={{ textAlign: "center", maxWidth: 640, margin: "10px auto 0", fontSize: 16 }}>
            ...
            <strong>no es flojera, no es la edad ni el trabajo — es tu tiroides, aunque tu examen diga “normal”.</strong>
          </p>
      ...
      <section className="section section-beige">
        <div className="container">
          ...
          <p className="lead">
            ...
            el yodo que necesita. Tu pastilla te repone la hormona… pero no esos nutrientes. Por eso
            sigues mamado y sin fuerzas, aunque tu TSH salga “normal”.
          </p>
          ...
          <div className="estres-grid">
            ...
            <div className="estres-card">
              ...
              <p>Sin esos nutrientes no produce T3 activa. Sigues sin fuerzas y mamado… aunque tu TSH salga “normal”.</p>
            </div>
          </div>
          ...
          <div className="estres-cierre">
            ...
            <p className="estres-disclaimer">
              ...
              con sueño y movimiento, y nótalo tú mismo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section section-beige">
        <div className="container">
          ...
          <p className="lead">Probaste el multivitamínico de la farmacia, más café, hasta pensaste que era normal a tu edad. Mira por qué MI TIROIDES ataca lo que los demás ni tocan.</p>
            ...
            {[
              {
                ...
                d: "Los primeros clientes reportan despertarse con más energía y dejar de apagarse a media tarde.",
              },
              {
                tag: "Mes 2",
                t: "Cabeza más despejada",
                d: "Al recibir B12, selenio y zinc, mejora el enfoque y baja la niebla mental durante la jornada.",
              },
              {
                tag: "Meses 2-3",
                t: "Peso más estable",
      ...
      <section className="section section-verde">
        <div className="container-sm" style={{ textAlign: "center" }}>
          ...
          <p className="lead" style={{ color: "#d6cdb3" }}>
            ...
            cambios reales en energía, peso y concentración.
          </p>
          <p style={{ color: "#d6cdb3", marginTop: 12 }}>
            Los que abandonan al primer mes no ven resultados.
            <br />
            <strong style={{ color: "#fff" }}>Los que completan los 3 meses, sí.</strong>
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          ...
          <h2 className="h2">Lo que reportan nuestros clientes en 90 días</h2>
          <div className="stats-grid">
            {[
              ["88%", "Reportan más energía y menos fatiga a media tarde al mes 2 de uso continuo"],
              ["91%", "Notan más concentración y menos niebla mental tras 8 semanas"],
              ["79%", "Sienten que su peso se estabiliza o baja sin cambios extremos en la dieta"],
              ["94%", "Volverían a comprar y lo recomendarían a un amigo o familiar"],
            ].map(([n, t]) => (
          ...
          <p style={{ textAlign: "center", color: "var(--gris)", marginTop: 22, fontSize: 12 }}>
            *Encuesta interna a clientes con 90 días de uso continuo. Resultados individuales varían.
          </p>
        </div>
      </section>
      ...
      <section className="section section-beige" id="testimonios">
        <div className="container">
          ...
          <h2 className="h2">Aprobado por +2.500 colombianos</h2>
          <p className="lead">Trabajadores, papás y abuelos que recuperaron su energía… y las esposas que los ayudaron.</p>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="lead">
            ...
            tomarlo y qué cambios reportan los que ya lo usan, semana a semana.
          </p>
      ...
      <section className="section section-beige" id="asistente">
        <div className="container-sm">
          ...
          <h2 className="h2" style={{ marginBottom: 6 }}>
            No estás solo en tu tratamiento.
          </h2>
          ...
          >
            {[
              ...
              >
                ...
                <div>
                  <div style={{ fontSize: 15, fontWeight: 700, color: "#17384f", marginBottom: 2 }}>
                    {it.t}
                  </div>
          ...
          >
            <strong style={{ color: "#17384f" }}>Importante:</strong> el asistente no reemplaza al médico — es un acompañamiento de hábitos y nutrición. Para temas clínicos siempre te recomendamos consultar a tu especialista.
          </div>
        </div>
      </section>
          ...
          <div className="faq">
            ...
            <details>
              ...
              <p>
                ...
                desayuno, para que no se interfieran. Muchos de nuestros clientes están en levotiroxina +
            ...
            <details>
              ...
              <p>
                ...
                sirven</strong> (yodo + selenio juntos), más el <strong>acompañamiento por
            ...
            <details>
              ...
              <p>
                La mayoría de clientes reporta más energía entre la 4ª y 6ª semana. Cambios en peso,
                concentración y ánimo se ven con más claridad entre el 2º y 3er mes. Por eso lo presentamos
            ...
            <details>
              ...
              <p>
                La fórmula usa dosis fisiológicas seguras. Si tienes una condición renal o hepática,
                consulta con tu médico antes de comenzar. No mezcla con
            ...
            <details>
              <summary>¿Esto es hormonas o testosterona?</summary>
              <p>
                No. MI TIROIDES <strong>no trae hormonas ni testosterona</strong>. Son nutrientes
                —selenio, zinc, yodo, L-tirosina, B12 y D3— que ayudan a tu tiroides a activar la hormona
                que tu cuerpo ya produce. Va con tu pastilla, no la reemplaza.
              </p>
            </details>
          </div>
        </div>
        ...
        <div className="container-sm">
          ...
          >
            ...
            <h2 className="h2" style={{ marginBottom: 14, fontSize: 26 }}>
              ¿Cuánto vale otra semana sintiéndote agotado?
            </h2>
            <p style={{ color: "var(--tinta)", fontSize: 16, lineHeight: 1.7, margin: 0 }}>
              ...
              sumándose al cansancio</strong>, otro día sin fuerzas para el
              trabajo y la familia, otro día con esa niebla que no te deja pensar.
              <br /><br />
              <strong style={{ color: "#17384f" }}>
      ...
      <section className="section section-verde">
        <div className="container-sm" style={{ textAlign: "center" }}>
          <h2 className="h2">¿Listo para empezar tu tratamiento?</h2>
          <p style={{ color: "#d6cdb3", marginBottom: 26 }}>
            Más de 2.500 colombianos ya están recuperando su energía con MI TIROIDES.
          </p>
        ...
        <div className="modal-overlay" onClick={closeModal} role="dialog" aria-modal="true">
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-head">
              ...
              <div className="modal-pill">+2.500 clientes felices</div>
            ...
            {ok && pedidoConfirmado ? (
              <div className="modal-success" style={{ textAlign: "center", padding: "8px 0" }}>
                ...
                <h3 style={{ margin: "0 0 8px", color: "#17384f" }}>
                  ¡Pedido recibido!
                </h3>
                ...
                <form className="modal-form" onSubmit={onSubmit} noValidate>
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 14, fontWeight: 700, color: "#17384f", marginBottom: 2 }}>
