...
export const DEPARTAMENTOS: Record<string, string[]> = {
  ...
  Antioquia: [
    ...
    "Guarne", "La Ceja", "Santa Fe de Antioquia", "Sonsón", "Vegachí",
  ...
  "La Guajira": [
    "Riohacha", "Maicao", "Uribia", "San Juan del Cesar",
    "Manaure", "Villanueva", "Fonseca", "Dibulla", "Albania",
  ...
  Santander: [
    ...
    "San Gil", "Socorro", "Málaga", "Vélez", "Cimitarra",
